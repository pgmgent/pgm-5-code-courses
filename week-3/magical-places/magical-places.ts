...
function addPlace(explorer: Explorer, place: GhentPlace): Explorer {
  explorer.push(place);
  console.log(
    `The mystical ${place.name} has been added to the explorer's map!`
  );
  return explorer;
}

function removePlace(explorer: Explorer, placeName: string): Explorer {
...
function listPlaces(explorer: Explorer): void {
