...
const widthContainer = document.getElementById(
  "width-container"
) as HTMLDivElement;
...
calculateButton.addEventListener("click", () => {
  ...
  const shape: Rectangle | Circle | Square = {
    type: selectedShape as "circle" | "square" | "rectangle",
    length,
    width: selectedShape === "rectangle" ? width : 0,
    radius: selectedShape === "circle" ? length : 0,
    sideLength: selectedShape === "square" ? length : 0,
  };
